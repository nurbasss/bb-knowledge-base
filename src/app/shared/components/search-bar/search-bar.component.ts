  ...
  implements OnInit
{
  ...
  searchResults: any[] = [
    {
      title: 'Кредиты',
      text: 'Вся информация о кредитах',
    },
    {
      title: 'Депозит "Гарант"',
      text: 'Вся информация по подключению и условиям депозита "Гарант" (Измененный текст)',
    },
    {
      title: 'Кредит "Выгодный"',
      text: 'Самый выгодный кредит',
    },
  ];
